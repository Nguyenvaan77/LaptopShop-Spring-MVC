                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form:form id="registerForm" action="/register" method="post" modelAttribute="registerDto">
                                            <div class="row mb-3">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><a class="btn btn-primary btn-block" href="javascript:;" onclick="document.getElementById('registerForm').submit();">Create Account</a></div>
                                            </div>
                                        </form:form>
                                    </div>

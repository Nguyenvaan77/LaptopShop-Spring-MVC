                                        ...
                                        <c:forEach var = "eachLaptop" items = "${products}">
                                            <div class="col-md-6 col-lg-4 col-xl-3">
                                                <div class="rounded position-relative fruite-item">
                                                    ...
                                                    <div class="text-white bg-secondary px-3 py-1 rounded position-absolute" style="top: 10px; left: 10px;">${eachLaptop.factory}</div>
                                                    <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                        <h4>
                                                            <a href="/product/${eachLaptop.id}">${eachLaptop.name}</a>
                                                        </h4>
                                                        <p>${eachLaptop.shortDesc}</p>
                                                        <div class="d-flex justify-content-center flex-lg-wrap">
                                                            <p  style="font-size: 15px; text-align: center; width: 100%;"
                                                                class="text-dark fw-bold mb-3">
                                                                <fmt:formatNumber type = "number" value = "${eachLaptop.price}"/>$
                                                            </p>
                                                            <form action="/add-product-to-cart/${eachLaptop.id}" method = "post">
